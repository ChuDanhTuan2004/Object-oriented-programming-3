...
public class Server {
    ...
    private String queryClient = "Insert into MessengerAppTable (messSendFromClient) values (?)";
    private String queryServer = "Insert into MessengerAppTable (messSendFromServer) values (?)";

    public void writeDataToSql(String check, String mess) {
        com.example.clientseverchatapp.client.ClientConnectJDBC clientConnectJDBC = new com.example.clientseverchatapp.client.ClientConnectJDBC();
        Connection conn = clientConnectJDBC.connect();
